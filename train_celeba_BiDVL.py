...
def parse_args():
    ...
    parser.add_argument('--dataset', default='celeba',  help='svhn | cifar10 | celeba | lsun | imagenet | folder')
    ...
    parser.add_argument('--lrQP', type=float, default=0.0003, help='learning rate for Q&P, default=0.0002')
    ...
    parser.add_argument('--lamb_vae', type=float, default=1.0, help='basic ratio between model and real density')
